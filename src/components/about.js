...
export default function About(props) {
	return (
		<section className="about-newsflash">
			...
			<p>
				Newsflash to save and get updated news for topics that interest you. You can browse headlines by
				category using the buttons at the top of the header.
			</p>
			<p>
				You can save an article by creating customized folders. To create a new folder, click on the side
				navigation bar to open the folder display. Create a new folder by typing a name in the input and press
